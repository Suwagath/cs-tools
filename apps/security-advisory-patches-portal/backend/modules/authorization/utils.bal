...
# Returns true when every `requiredRoles` value appears in `userRoles`.
#
# + requiredRoles - Roles required for the operation
# + userRoles - Roles present on the signed-in user
