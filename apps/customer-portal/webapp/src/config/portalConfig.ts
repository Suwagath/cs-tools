...
export interface CustomerPortalWindowConfig {
  ...
  CUSTOMER_PORTAL_UPPER_TOP_BANNER_ENABLED?: boolean;
  CUSTOMER_PORTAL_UPPER_TOP_BANNER_HTML?: string;
  CUSTOMER_PORTAL_UPPER_TOP_BANNER_CLOSEABLE?: boolean;
  CUSTOMER_PORTAL_UPPER_TOP_BANNER_STORAGE_KEY?: string;
  CUSTOMER_PORTAL_LOWER_TOP_BANNER_ENABLED?: boolean;
  CUSTOMER_PORTAL_LOWER_TOP_BANNER_HTML?: string;
  CUSTOMER_PORTAL_LOWER_TOP_BANNER_CLOSEABLE?: boolean;
  CUSTOMER_PORTAL_LOWER_TOP_BANNER_STORAGE_KEY?: string;
